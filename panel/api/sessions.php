...
case 'start':
    ...
    /*
     * برای جیتسی، اتاق همیشه از شناسهٔ همین جلسه ساخته می‌شود — حتی اگر
     * جلسه‌ای قدیمی هنوز آدرس سطح کلاس را در پایگاه داشته باشد. برای
     * بقیهٔ ارائه‌دهنده‌ها لینک دستیِ مدرس یا لینک کلاس می‌ماند.
     */
    $url = (string)$cl['provider'] === 'jitsi'
        ? jitsi_room_url((string)$s['id'])
        : (join_url_in($in, 'joinUrl') ?? $s['join_url'] ?? $cl['join_url']);
